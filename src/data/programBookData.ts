...
export const historyIntro =
  "1998년 부산·경남 정록회와 대구·경북 정동회의 친선 라운딩에서 출발해, 영남과 호남 정보통신업계가 함께 어울리는 전국 최대 규모의 친선 골프대회로 자리잡았습니다.";

export const historyMilestones: HistoryMilestone[] = [
  {
    id: "h1998",
    year: "1998",
    text: "부산·경남 정록회와 대구·경북 정동회가 '영남지역 통신업체 친선골프대회'라는 이름으로 시작.",
  },
  {
    id: "h2000",
    year: "2000",
...
export const historyFullText = `본 대회는 1998년 당시 부산·경남의 정록회와 대구·경북의 정동회가 영남지역 통신업체 친선골프대회라는 대회명으로 시작이 되었으며, 2000년 부산·경남의 이정부·전지원 회장님과 광주·전남의 김만웅 회장님과 대구·경북의 황보유·서동천 회장님 다섯 분이 모여 영·호남 정보통신업체 간의 상호 교류의 장을 만들어 동과 서의 화합과 친목을 도모하자는 의견으로 태동하였습니다.

그 이듬해인 2001년 10월 15일 광주·전남 통우회 주최로 클럽900CC에서 정통회, 정록회, 통우회 회원 70여 명이 참여하여 제1회 대회를 개최하였으며 2002년 부산, 2003년 대구 지역으로 순회하게 되었습니다.

전북은 개인 자격으로 참여를 해오다 2004년에 전통회가 발족되면서 4개 시·도회가 순회하는 영·호남 정보통신사업자 친선골프대회로 시작하여 지난 제23회까지 이어져 왔습니다.
...
export const gameInfoCards = [
  { id: "g1", label: "참가 규모", value: `${eventInfo.teamCount}팀 ${eventInfo.playerCount}명` },
...
export type SponsorGroup = "광주·전남도회 현금 협찬" | "광주·전남도회 물품 협찬" | "외부 협찬";
...
export const sponsorEntries: SponsorEntry[] = [
  // ---- 광주·전남도회 현금 협찬 (30건) ----
  { id: "s1", no: 1, group: "광주·전남도회 현금 협찬", name: "정종만", company: "(유)지원통신", role: "통우회장", amount: 5_000_000 },
  { id: "s2", no: 2, group: "광주·전남도회 현금 협찬", name: "김상호", company: "㈜온시스템", role: "광주·전남도회장", amount: 2_000_000 },
  { id: "s3", no: 3, group: "광주·전남도회 현금 협찬", name: "채강석", company: "㈜코리아넷", role: "광주·전남도회 부회장", amount: 2_000_000 },
  { id: "s4", no: 4, group: "광주·전남도회 현금 협찬", name: "운영위원회", amount: 3_000_000 },
  { id: "s5", no: 5, group: "광주·전남도회 현금 협찬", name: "윤리위원회", amount: 1_000_000 },
  { id: "s6", no: 6, group: "광주·전남도회 현금 협찬", name: "제도개선위원회", amount: 1_000_000 },
  { id: "s7", no: 7, group: "광주·전남도회 현금 협찬", name: "박화진", role: "윤리위원장", amount: 1_000_000 },
  { id: "s8", no: 8, group: "광주·전남도회 현금 협찬", name: "이승호", role: "제도개선위원장", amount: 1_000_000 },
  { id: "s9", no: 9, group: "광주·전남도회 현금 협찬", name: "호남골프회", amount: 1_000_000 },
  { id: "s10", no: 10, group: "광주·전남도회 현금 협찬", name: "광전회", amount: 1_000_000 },
  { id: "s11", no: 11, group: "광주·전남도회 현금 협찬", name: "박승수", role: "광전회장", amount: 1_000_000 },
  { id: "s12", no: 12, group: "광주·전남도회 현금 협찬", name: "이인중", amount: 1_000_000 },
  { id: "s13", no: 13, group: "광주·전남도회 현금 협찬", name: "진승원", amount: 1_000_000 },
  { id: "s14", no: 14, group: "광주·전남도회 현금 협찬", name: "구학인", amount: 1_000_000 },
  { id: "s15", no: 15, group: "광주·전남도회 현금 협찬", name: "이건국", amount: 500_000 },
  { id: "s16", no: 16, group: "광주·전남도회 현금 협찬", name: "김정곤", amount: 500_000 },
  { id: "s17", no: 17, group: "광주·전남도회 현금 협찬", name: "김만웅", amount: 1_000_000, note: "금일봉" },
  { id: "s18", no: 18, group: "광주·전남도회 현금 협찬", name: "최공호", amount: 500_000 },
  { id: "s19", no: 19, group: "광주·전남도회 현금 협찬", name: "윤종아", amount: 500_000 },
  { id: "s20", no: 20, group: "광주·전남도회 현금 협찬", name: "김필호", amount: 300_000 },
  {
    id: "s21",
    no: 21,
    group: "광주·전남도회 현금 협찬",
  ...
  { id: "s22", no: 22, group: "광주·전남도회 현금 협찬", name: "손대겸", amount: 300_000 },
  { id: "s23", no: 23, group: "광주·전남도회 현금 협찬", name: "이영만", amount: 300_000 },
  { id: "s24", no: 24, group: "광주·전남도회 현금 협찬", name: "이종모", amount: 300_000 },
  { id: "s25", no: 25, group: "광주·전남도회 현금 협찬", name: "김정훈", amount: 500_000 },
  { id: "s26", no: 26, group: "광주·전남도회 현금 협찬", name: "서영균", amount: 500_000 },
  { id: "s27", no: 27, group: "광주·전남도회 현금 협찬", name: "양해용", amount: 300_000 },
  { id: "s28", no: 28, group: "광주·전남도회 현금 협찬", name: "최수형", amount: 300_000 },
  { id: "s29", no: 29, group: "광주·전남도회 현금 협찬", name: "김대희", amount: 300_000 },
  { id: "s30", no: 30, group: "광주·전남도회 현금 협찬", name: "기승주", role: "서부권 회원사", amount: 1_000_000 },
